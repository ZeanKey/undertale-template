...
_phase0.Events.EvStart.AddCallback(-1, function () {
	...
	Dialog.Add("space_sans_fight turn sans.", battle.Enemies.Find(0));
	Dialog.Generate();
});

_phase1 = new TurnSubPhase(id, TURN_SUBPHASE_TYPE.BATTLE);

_BoardHelper.SetInEase(100, 100, 65, 65, 30, new AnimCurveFormat(ANIM_TWEEN.CUBIC, ANIM_EASE.IN_OUT));
